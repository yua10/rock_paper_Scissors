## Weeks 8-9 - Multidisciplinary Project - UKPN

You will be working in teams to identify, design and implement a tech solution for UKPN.
...
| -- | -- | -- | -- | -- |
| AM |  | Start Development | UKPN in Office | |
| PM | Finalise planning & Pitches _(see <a href="#requirements--guidelines">Requirements & Guidance > Pitch Requirements</a>)_ | | UKPN in Office | Full team retro |

### Week 2
| | Wednesday | Thursday | Friday |
| -- | -- | -- | -- | 
| AM | UKPN in Office | Halt code & merge to main + 1st Dry Runs | 2nd Dry Runs |
| PM | UKPN in Office <br>Feature Freeze*** | Implement 1st Dry Run feedback | Presentations _(see <a href="#requirements--guidelines">Requirements & Guidance > Presentation Requirements</a>)_ |
...
- **EITHER** create a project around one of the big challenges for UKPN and the wider energy sector at the moment:
  - Renewables
  - Forecasting EVs
  - UK Energy Mix
  - CO2 Consumption
- **OR** use [UKPN's open datasets](https://ukpowernetworks.opendatasoft.com/pages/home/) to drive a project of your choosing 
...
Remember, **UKPN** use certain tools across their organisation. It's not compulsory (and won't always be relevant), but we'd advise that you used these technologies in your project where you can:
- Python
- Azure
- Plotly Dash
- databricks
...
| Specialism | Tasks |
| -- | -- | 
| CDO | Implement API + Containerisation + Microservices + Lead Developer Backend |
| Change | Implement Business Case + Lead Project using Agile + Supporting developer Frontend |
| Data | Support PM in Business Case + Implement Database + Connection to API + Data Cycle + Data Visuals + Supporting Developer Backend |
